      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-2">
              ...
              <span className={`font-medium tracking-wide ${language === 'ar' ? 'font-harmattan' : ''}`}>{t('hero.availableForWork')}</span>
        ...
        >
          <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-tight
            ${theme === 'dark' ? 'text-white' : 'text-gray-800'} ${language === 'ar' ? 'font-harmattan' : ''}`}
          >
            {t('hero.greeting')}{' '}
          ...
          <p className={`text-lg md:text-xl ${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} max-w-2xl mx-auto mb-6 ${language === 'ar' ? 'font-harmattan' : ''}`}>
            {t('hero.title')}
          </p>
          ...
          >
            ...
            >
              ...
              <span className={`relative z-10 text-base group-hover:translate-x-1 transition-transform duration-300 ${language === 'ar' ? 'font-harmattan' : ''}`}>
                {t('hero.viewProjects')}
              </span>
            </motion.a>
